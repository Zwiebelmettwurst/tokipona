...
enum GoldenCorpus {
    ...
    static let valid: [Valid] = [
        ...
        // Stufe 9 — pi
        .init(stage: 9, sentence: "jan pi toki pona li pona.", gloss: "toki-pona-Sprecher sind gut."),
        .init(stage: 9, sentence: "mi lukin e lipu pi toki pona.", gloss: "Ich lese ein toki-pona-Buch."),
        .init(stage: 9, sentence: "kulupu pi jan pona li suli.", gloss: "Die Gruppe der Freunde ist groß."),
        .init(stage: 9, sentence: "mi jo e ilo pi kalama musi.", gloss: "Ich habe ein Musikinstrument."),

        // Stufe 5 — Präverben
        .init(stage: 5, sentence: "mi wile moku.", gloss: "Ich will essen."),
        .init(stage: 5, sentence: "sina ken toki.", gloss: "Du kannst sprechen."),
        .init(stage: 5, sentence: "ona li kama sona.", gloss: "Sie lernt."),
        .init(stage: 5, sentence: "mi sona toki.", gloss: "Ich kann sprechen."),
        .init(stage: 5, sentence: "mi wile e ijo.", gloss: "Ich will etwas."),
        .init(stage: 5, sentence: "mi awen lape.", gloss: "Ich schlafe weiter."),

        // Stufe 6 — Präpositionen
        .init(stage: 6, sentence: "mi tawa tomo.", gloss: "Ich gehe nach Hause."),
        .init(stage: 6, sentence: "ona li lon ma.", gloss: "Sie ist im Land."),
        .init(stage: 6, sentence: "mi pali kepeken ilo.", gloss: "Ich arbeite mit einem Werkzeug."),
        .init(stage: 6, sentence: "jan li pana e lipu tawa mi.", gloss: "Jemand gibt mir ein Dokument."),
        .init(stage: 6, sentence: "mi lape lon tomo mi.", gloss: "Ich schlafe in meinem Haus."),
        .init(stage: 6, sentence: "mi tawa.", gloss: "Ich gehe."),
        .init(stage: 6, sentence: "ona li sama mi.", gloss: "Sie ist wie ich."),
        // Präpositionen sind auch Inhaltswörter: im Subjekt können sie nur
        // Beifügung sein, und ohne Ergänzung sind sie es ebenfalls.
        .init(stage: 6, sentence: "tomo tawa mi li pona.", gloss: "Mein Auto ist gut."),
        .init(stage: 6, sentence: "meli sama mi li suli.", gloss: "Meine Schwester ist groß."),
        .init(stage: 6, sentence: "ona li toki e ijo lon.", gloss: "Sie sagt die Wahrheit."),

        // Stufe 7 — Verneinung und Fragen
        .init(stage: 7, sentence: "mi moku ala.", gloss: "Ich esse nicht."),
        .init(stage: 7, sentence: "sina wile ala wile moku?", gloss: "Willst du essen?"),
        .init(stage: 7, sentence: "ona li pona ala pona?", gloss: "Ist es gut?"),
        .init(stage: 7, sentence: "sina pali e seme?", gloss: "Was machst du?"),
        .init(stage: 7, sentence: "jan seme li toki?", gloss: "Wer spricht?"),
        .init(stage: 7, sentence: "ona li pona anu seme?", gloss: "Ist es gut, oder?"),
        .init(stage: 7, sentence: "mi wile ala moku.", gloss: "Ich will nicht essen."),
        // sona ist präverbfähig, trägt hier aber selbst das Objekt.
        .init(stage: 7, sentence: "ona li sona ala sona e toki pona?", gloss: "Kann sie toki pona?"),

        // Stufe 8 — o, Namen, a
        .init(stage: 8, sentence: "o kama pona!", gloss: "Willkommen!"),
        .init(stage: 8, sentence: "jan Sonja o toki!", gloss: "Sonja, sprich!"),
        .init(stage: 8, sentence: "sina o lape.", gloss: "Schlaf du."),
        .init(stage: 8, sentence: "mi pona a!", gloss: "Mir geht es gut!"),
        .init(stage: 8, sentence: "o pana e telo tawa mi.", gloss: "Gib mir Wasser."),
        .init(stage: 8, sentence: "jan pona o!", gloss: "Freund!"),
        ...
        .init(stage: 11, sentence: "ona li pona mute anu ike mute.", gloss: "Es ist sehr gut oder sehr schlecht."),

        // Stufe 12 — Zahlen
        .init(stage: 12, sentence: "soweli tu li lape.", gloss: "Zwei Tiere schlafen."),
        .init(stage: 8, sentence: "jan Sonja li pali e toki pona.", gloss: "Sonja hat toki pona gemacht."),
        .init(stage: 12, sentence: "mi jo e kili wan.", gloss: "Ich habe eine Frucht."),
        .init(stage: 8, sentence: "ma Tosi li suli.", gloss: "Deutschland ist groß."),
        .init(stage: 8, sentence: "nimi mi li jan Ken.", gloss: "Mein Name ist Ken."),
